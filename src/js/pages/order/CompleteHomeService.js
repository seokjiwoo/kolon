...
module.exports = function() {
	...
	function onControllerListener(e, status, result, elements) {
		...
		switch(eventType) {
			default:
				...
				result.data.washServiceDetail.priceDesc = util.currencyFormat(result.data.washServiceDetail.price);
	...
	function myInfoResultHandler(e) {
		...
		if (loginData == null) {
			...
			controller.ordersHomeServiceComplete(self.orderNumber);
		}
	}
